...
# 脚本功能：获取该地址指定时间范围内的代币交易之后，再筛选出指定代币数量内的交易

# ======================
# 配置参数
# ======================
API_KEY = " "  # 替换为你的 API Key
ADDRESS = "0x73D8bD54F7Cf5FAb43fE4Ef40A62D390644946Db".lower()  # 目标地址（统一小写）
TOKEN_ADDRESS = "0x75a5863a19af60ec0098d62ed8c34cc594fb470f"  # 代币合约地址
START_DATE_UTC = "2025-07-06 13:00:00"  # UTC时间（开始时间）
END_DATE_UTC = "2025-07-06 14:00:00"    # UTC时间（结束时间）
MIN_AMOUNT = 1000  # 最小金额（代币数量）
...
if filtered_txs:
    ...
    # 保留关键列并排序
    df = df[["blockNumber", "交易时间(UTC)", "hash", "from", "to", "实际交易金额", "tokenSymbol", "交易方向"]]
    ...
    print("文件字段：区块高度, 交易时间(UTC), 交易哈希, 转出地址, 转入地址, 实际金额, 代币符号, 交易方向")
else:
    print("\n[结果为空] 未找到符合条件的交易记录")